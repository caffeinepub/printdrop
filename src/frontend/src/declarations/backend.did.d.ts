...
export interface IntegrationConfig { 'apiEndpoint' : string, 'apiKey' : string }
...
export interface _SERVICE {
  ...
  'setIntegrationConfig' : ActorMethod<[IntegrationConfig], undefined>,
  'setStripeConfiguration' : ActorMethod<[StripeConfiguration], undefined>,
  'testIntegration' : ActorMethod<[], string>,
